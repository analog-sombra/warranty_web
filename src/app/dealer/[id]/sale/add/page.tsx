...
const createCustomerSaleApi = async (
  data: CreateCustomerSaleInput
): Promise<{ id: number }> => {
...
const updateDealerStockByProductApi = async (
  ...
  const response = await ApiCall<{
    updateDealerStockByProduct: { id: number; quantity: number };
  }>({
...
const AddCustomerSalePage: React.FC<AddCustomerSalePageProps> = () => {
  ...
  const [pendingFormData, setPendingFormData] =
    useState<AddCustomerSaleForm | null>(null);
  ...
  const { data: dealerProducts = [], isLoading: isProductsLoading } = useQuery({
  ...
  const createSaleMutation = useMutation({
    mutationFn: async (data: AddCustomerSaleForm) => {
      ...
      if (!selectedCustomer) {
        throw new Error(
          "Customer not found. Please verify the contact number."
        );
      }
      ...
      try {
        ...
        try {
          ...
          if (currentStock && currentStock.quantity > 0) {
            ...
            toast.warning(
              "Sale created but automatic stock reduction failed. Please update stock manually."
            );
          }
        } catch (fallbackError) {
          console.error("Fallback stock update also failed:", fallbackError);
          toast.warning(
            "Sale created successfully, but stock reduction failed. Please check and update stock manually."
          );
        }
      }
                ...
                <Descriptions column={1} size="middle" bordered>
                  ...
                  <Descriptions.Item label="Stock Impact">
                    <div className="flex items-center gap-2">
                      <Tag color="blue">
                        Current: {selectedProduct.quantity} units
                      </Tag>
                      <span>→</span>
                      <Tag color="orange">
                        After Sale: {selectedProduct.quantity - 1} units
                      </Tag>
                    </div>
                  </Descriptions.Item>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500 mt-1">
                  Create a sale to customer and reduce dealer stock
                </p>
              </div>
            </div>
          </div>
          ...
          <Card className="border-orange-300 bg-orange-50">
            <div className="text-center py-8">
              ...
              <p className="text-orange-700 mb-4">
                This dealer has no products in stock. Please add stock before
                creating customer sales.
              </p>
              <Button
                type="primary"
                onClick={() => router.push(`/dealer/${dealerId}/stock`)}
                      ...
                      <div className="mt-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                        <div className="flex items-start gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-blue-700 text-sm mt-1">
                              Only products with available stock (quantity &gt;
                              0) are shown. Each sale will reduce stock by 1
                              unit.
                            </p>
                          </div>
                        </div>
                                ...
                                <div className="flex items-start gap-3">
                                  ...
                                  <div className="flex-1">
                                    <p className="text-blue-800 font-medium text-sm mb-2">
                                      No customer found with contact{" "}
                                      {watchedContact}
                                    </p>
                                    ...
                                    <div className="mt-3 p-2 bg-blue-100 rounded text-xs text-blue-700">
                                      <strong>Note:</strong> Customer will be
                                      created with role "USER" and quantity set
                                      to 1
                                    </div>
                                  </div>
                                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <ul className="text-xs text-gray-600 space-y-1 list-disc list-inside">
                        <li>
                          This will create a customer sale record with the
                          specified warranty period
                        </li>
                        <li>
                          Dealer stock quantity will be reduced by 1 unit
                          automatically
                        </li>
                        <li>
                          Customer must exist in the system with the provided
                          contact number
                        </li>
                        <li>
                          Company ID will be derived from the selected product
                        </li>
