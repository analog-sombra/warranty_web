...
const DealerStockPage: React.FC<DealerStockPageProps> = () => {
  ...
  // Fetch dealer info
  const { data: dealerInfo, isLoading: isDealerLoading } = useQuery({
        ...
        cell: (info) => {
          ...
          return (
            <Button
              ...
              icon={<EyeOutlined />}
              onClick={() =>
                router.push(`/dealer/${dealerId}/stock/${stock.id}`)
              }
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500 mt-1">
                  Manage dealer inventory and stock levels
                </p>
              </div>
            </div>
