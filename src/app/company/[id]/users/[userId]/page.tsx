...
const UserDetailsPage = () => {
  ...
  const getRoleColor = (role: string) => {
    const roleColors = {
      "MANUF_ADMIN": "purple",
      "MANUF_ACCOUNTS": "green",
      "MANUF_MANAGER": "blue",
      "MANUF_SALES": "orange",
      "MANUF_TECHNICAL": "gray",
    };
          ...
          <Card
            title={
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg font-semibold text-blue-700">Personal Information</span>
              </div>
            }
          ...
          >
            <Descriptions column={1} className="mb-6">
              <Descriptions.Item label="Full Name">
                <Text strong className="text-blue-900 text-lg">
                  {userData?.name}
                </Text>
              </Descriptions.Item>
          ...
          <Card
            title={
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-green-700">Role & Location</span>
              </div>
            }
        ...
        <Card
          title={
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-purple-700">System Information</span>
            </div>
          }
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-4 bg-blue-50 rounded-lg">
              ...
              <Text className="text-blue-600 text-sm font-medium block mb-1">User ID</Text>
              <Text strong className="text-blue-900 text-lg">{userData?.id}</Text>
            </div>
            ...
            <div className="text-center p-4 bg-purple-50 rounded-lg">
              ...
              <Text className="text-purple-600 text-sm font-medium block mb-1">Company ID</Text>
              <Text strong className="text-purple-900 text-lg">{companyId}</Text>
            </div>
          </div>
        </Card>
      </div>
