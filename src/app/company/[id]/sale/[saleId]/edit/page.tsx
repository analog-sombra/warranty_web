...
const EditSalePage: React.FC<EditSalePageProps> = () => {
  ...
  const updateMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      router.push(`/company/${companyId}/sale/${saleId}`);
    },
    onError: (error: Error) => {
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600 mt-1">
                        Updating sale information will affect warranty
                        calculations and dealer inventory records. Please ensure
