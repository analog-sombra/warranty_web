...
// Icons
let ArrowLeftOutlined: any, CalendarOutlined: any, ShoppingOutlined: any, BankOutlined: any;
try {
...
// API function
const fetchDealerStockById = async (stockId: number): Promise<DealerStockDetail> => {
...
const DealerStockViewPage: React.FC<DealerStockViewPageProps> = ({ params }) => {
                ...
                <div className="max-w-4xl mx-auto p-6">
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 px-6 py-8">
                        <div className="text-center">
                            ...
                            <Title level={3} className="text-gray-900">Stock Not Found</Title>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <Card title="Stock Overview" className="shadow-sm">
                            <Descriptions column={2}>
                                ...
                                >
                                    <span className="font-mono text-gray-800">#{stockData.id}</span>
                                </Descriptions.Item>
                                <Descriptions.Item
                                ...
                                >
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span>{new Date(stockData.createdAt).toLocaleDateString()}</span>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        ...
                                        <Tag color={stockData.product.status === "ACTIVE" ? "green" : "red"}>
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            <div className="space-y-3">
                                <div>
                                    <Text type="secondary" className="text-sm">Dealer Name</Text>
                                    <div className="font-semibold text-gray-900">
                                        {stockData.dealer.name}
                                    </div>
                                </div>
                                <div>
                                    <Text type="secondary" className="text-sm">Dealer ID</Text>
                                ...
                                <Button
                                    ...
                                    onClick={() => router.push(`/admin/dealers/${stockData.dealer.id}`)}
                                >
                                    View Dealer Profile →
                                </Button>
                            </div>
                        ...
                        <Card title="Company Information" className="shadow-sm">
                            <div className="space-y-3">
                                <div>
                                    <Text type="secondary" className="text-sm">Company Name</Text>
                                    <div className="font-semibold text-gray-900">
                                        {stockData.company.name}
                                    </div>
                                </div>
                                <div>
                                    <Text type="secondary" className="text-sm">Company ID</Text>
                                    <div className="font-mono text-gray-600">
                                ...
                                <Button
                                    type="link"
                                    className="p-0 h-auto"
                                    onClick={() => router.push(`/admin/companies/${stockData.company.id}`)}
                                >
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                                    ...
                                    <span className="text-blue-900 font-bold text-lg">
                                        ₹{(stockData.quantity * stockData.product.price).toLocaleString()}
                                    </span>
                                </div>
                                ...
                                <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                                    ...
                                    <span className="text-purple-900 font-bold">
                                        {Math.floor((Date.now() - new Date(stockData.createdAt).getTime()) / (1000 * 60 * 60 * 24))} days
                                    </span>
                                </div>
                            </div>
                        </Card>
