...
import { Card, Typography, Button, Table, Tag, Space, Input, Spin, Modal } from "antd";
...
const CustomerSalesPage: React.FC<CustomerSalesPageProps> = ({ params }) => {
    ...
    const {
        ...
        queryFn: () => fetchCustomerSales(dealerId, {
            take: pageSize,
    ...
    const columns = [
        {
            ...
            width: 70,
            render: (id: number) => (
                <Tag color="blue" className="text-xs">#{id}</Tag>
            ),
        },
        {
            title: "Product",
            ...
            render: (record: CustomerSale) => (
                <div className="max-w-48">
                    <div className="font-medium text-gray-900 text-sm truncate" title={record.product.name}>
                        {record.product.name}
                    </div>
                    <div className="text-xs text-gray-500 truncate" title={`ID: ${record.product.id}`}>
        ...
        },
        {
            ...
            render: (record: CustomerSale) => (
                <Button
                    ...
                    size="small"
                    icon={<EyeOutlined />}
                    onClick={() => router.push(`/admin/dealers/${dealerId}/sale/${record.id}`)}
                    title="View Details"
            ...
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <Card className="max-w-md">
                    <div className="text-center">
                        ...
                        <Title level={4} className="text-red-600">Failed to Load Sales</Title>
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 px-6 py-4">
                    <div className="flex justify-between items-center">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <Title level={3} className="!mb-0 text-gray-900 flex items-center gap-2">
                        ...
                        <Button
                            type="primary"
                            icon={<PlusOutlined />}
                            onClick={() => router.push(`/admin/dealers/${dealerId}/sale/add`)}
