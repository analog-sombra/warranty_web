...
import { Card, Typography, Tag, Button, Spin, Descriptions, Space, Modal } from "antd";
...
const DealerDetailsPage: React.FC<DealerDetailsPageProps> = ({ params }) => {
    ...
    // Handle edit
    const handleEdit = () => {
        router.push(`/admin/dealers/${dealerId}/edit`);
    };
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">
                                        ID: {dealer.id} • {dealer.zone?.city?.name || 'N/A'}, {dealer.zone?.name || 'N/A'}
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div className="max-w-6xl mx-auto p-6 space-y-6">
                ...
                <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                    ...
                    <Button
                        ...
                        onClick={() => router.push(`/admin/dealers/${dealerId}/users`)}
                    ...
                    <Button
                        ...
                        onClick={() => router.push(`/admin/dealers/${dealerId}/sale`)}
                ...
                <Card title="Dealer Information" className="shadow-sm">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <Descriptions column={1} size="middle">
                            ...
                            <Descriptions.Item label="Primary Contact">{dealer.contact1}</Descriptions.Item>
                            {dealer.contact2 && (
                                <Descriptions.Item label="Secondary Contact">{dealer.contact2}</Descriptions.Item>
                            )}
                            <Descriptions.Item label="Address">{dealer.address}</Descriptions.Item>
                        </Descriptions>
                        ...
                        <Descriptions column={1} size="middle">
                            ...
                            {dealer.gst && (
                                <Descriptions.Item label="GST Number">{dealer.gst}</Descriptions.Item>
                            )}
                            {dealer.pan && (
                                <Descriptions.Item label="PAN Number">{dealer.pan}</Descriptions.Item>
                            )}
                            <Descriptions.Item label="Status">
                                <Tag color={dealer.status === "ACTIVE" ? "green" : "red"} className="font-medium">
                                    {dealer.status}
                                </Tag>
                            </Descriptions.Item>
